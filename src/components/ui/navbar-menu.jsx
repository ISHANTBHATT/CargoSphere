  ...
  return (
    <div onMouseEnter={() => setActive(item)} className="relative ">
      <motion.p
        ...
        className="cursor-pointer hover:opacity-[0.9] text-black"
      >
        {item}
      </motion.p>
      {active !== null && (
...
export const Menu = ({ setActive, children }) => {
  ...
  return (
    <nav
      ...
      className="relative rounded-full border  bg-gray-50 border-white/[0.2]  shadow-input md:flex justify-between items-center space-x-4 px-10 py-6 hidden"
...
export const HoveredLink = ({ children, ...rest }) => {
  return (
    <Link {...rest} className="text-neutral-200 hover:text-neutral-400 ">
      {children}
    </Link>
  );
};
